    ...
    <div class="block-form">
    	...
    	<form name="EasyFacebookPostFeed_settings" method="post" enctype="multipart/form-data">
			...
			<div class="form-wrap">
				...
				<?php if(get_option('EasyFacebookPostFeed_display_images') == 'yes') { ?>
				<div class="form-field">
					<?php _e( 'Image alignment', 'easy-facebook-post-feed' ); ?>
					<br />
					<select name="EasyFacebookPostFeed_display_align">
						<option value="left" <?php if(get_option('EasyFacebookPostFeed_display_align') == 'left') { echo 'selected="selected"'; } ?>><?php _e( 'Left', 'easy-facebook-post-feed' ); ?></option>
						<option value="below" <?php if(get_option('EasyFacebookPostFeed_display_align') == 'below') { echo 'selected="selected"'; } ?>><?php _e( 'Text below', 'easy-facebook-post-feed' ); ?></option>
						<option value="right" <?php if(get_option('EasyFacebookPostFeed_display_align') == 'right') { echo 'selected="selected"'; } ?>><?php _e( 'Right', 'easy-facebook-post-feed' ); ?></option>
					</select>
				</div>
				<?php } ?>

				<div class="form-field">
					<?php _e( 'Display date', 'easy-facebook-post-feed' ); ?>
					<br />
					<input type="checkbox" class="display_date" name="EasyFacebookPostFeed_display_date" maxlength="7" <?php if(get_option('EasyFacebookPostFeed_display_date') == 'yes') echo 'checked'; ?> />
				</div>
