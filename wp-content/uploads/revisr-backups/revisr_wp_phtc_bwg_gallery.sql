...
DROP TABLE IF EXISTS `wp_phtc_bwg_gallery`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wp_phtc_bwg_gallery` (
...
LOCK TABLES `wp_phtc_bwg_gallery` WRITE;
/*!40000 ALTER TABLE `wp_phtc_bwg_gallery` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_phtc_bwg_gallery` ENABLE KEYS */;
UNLOCK TABLES;
